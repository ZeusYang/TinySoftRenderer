...
void Mesh::asFloor(double length, double height)
{
    vertices.resize(4);
    indices.resize(6);
    vertices[0].position = Vector3D(+length*0.5f, height, -length*0.5f);
    vertices[0].normal = Vector3D(0.f, 1.f, 0.f);
    vertices[0].color = Vector4D(1.f, 0.f, 0.f, 1.f);
    vertices[0].texcoord = Vector2D(0.f, 0.f);
    vertices[1].position = Vector3D(-length*0.5f, height, -length*0.5f);
    vertices[1].normal = Vector3D(0.f, 1.f, 0.f);
    vertices[1].color = Vector4D(0.f, 0.f, 0.f, 1.f);
    vertices[1].texcoord = Vector2D(1.f, 0.f);
    vertices[2].position = Vector3D(-length*0.5f, height, +length*0.5f);
    vertices[2].normal = Vector3D(0.f, 1.f, 0.f);
    vertices[2].color = Vector4D(0.f, 0.f, 1.f, 1.f);
    vertices[2].texcoord = Vector2D(1.f, 1.f);
    vertices[3].position = Vector3D(+length*0.5f, height, +length*0.5f);
    vertices[3].normal = Vector3D(0.f, 1.f, 0.f);
    vertices[3].color = Vector4D(0.f, 0.f, 0.f, 1.f);
    vertices[3].texcoord = Vector2D(0.f, 1.f);
    indices[0] = 0;
    indices[1] = 1;
    indices[2] = 2;
    indices[3] = 0;
